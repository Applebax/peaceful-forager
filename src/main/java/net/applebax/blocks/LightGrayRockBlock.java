...
public class LightGrayRockBlock extends Block implements Waterloggable
{
    public static final BooleanProperty WATERLOGGED = Properties.WATERLOGGED;

    protected static final VoxelShape SHAPE;

    public LightGrayRockBlock(Settings settings)
    {
        super(settings);
    ...
    static {
        SHAPE = Block.createCuboidShape(4.0D, 0.0D, 4.0D, 12.0D, 2.0D, 12.0D);
    }
}
